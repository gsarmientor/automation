...
describe('Continuum Regression - 4. Package page \n', function () {
    ...
    it("4.1 validate items on the 'Add New' dialog", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, packageModule.validateAddNewDialog()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("4.2 add new Package", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, packageModule.addPackage("DEFAULT", continuumCommonPage.pckgName, continuumCommonPage.pckgDesc)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("4.3 validate Package Details", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, packageModule.validatePackageDetails()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("4.4 select a Package", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, packageModule.selectPackage(continuumCommonPage.pckgName)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("4.5 associate a Progression", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("4.6 associate an Artifact", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, packageModule.associateArtifact("", "")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
