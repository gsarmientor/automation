...
describe('Continuum Regression - 2. Admin pages \n', function () {
    ...
    it('1. should validate pages in Admin menu', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, continuumCommonModule.validateAdminMenu()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
